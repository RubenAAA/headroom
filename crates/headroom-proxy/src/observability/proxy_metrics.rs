...
use super::metric_names::{
    ...
    METRIC_PROXY_RATELIMIT_UNIFIED_UTILIZATION_HELP, METRIC_PROXY_RESPONSE_STATUS_COUNT_TOTAL,
    METRIC_PROXY_RESPONSE_STATUS_COUNT_TOTAL_HELP, METRIC_PROXY_SERVICE_TIER_COUNT_TOTAL,
    METRIC_PROXY_SERVICE_TIER_COUNT_TOTAL_HELP, METRIC_PROXY_STREAM_INCOMPLETE_TOTAL,
    METRIC_PROXY_STREAM_INCOMPLETE_TOTAL_HELP, METRIC_PROXY_UPSTREAM_RETRIES_EXHAUSTED_TOTAL,
...
mod tests {
    ...
    fn record_unified_emits_subscription_gauges() {
        ...
        assert!(
            body.contains(
                r#"proxy_ratelimit_unified_reset_seconds{window="5h_rectest"} 1781973000"#
            )
        );
