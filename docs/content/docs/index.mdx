...
Point Claude Code at the local proxy and every turn gets cache stabilization,
compression, and observability. See [Quickstart](/docs/quickstart).
...
the reproducible scenario table below for measured numbers on real workloads.
...
See [Metrics](/docs/metrics) for the live numbers.
