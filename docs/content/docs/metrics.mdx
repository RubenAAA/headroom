...
| `headroom_tool_schema_saved_total` | Runtime tool-schema tokens kept out of context by deferral (the additive share of the headline; dashboards sum both) | Higher is better |
