...
| Mode | Use when | Notes |
|---|---|---|
| Proxy | You want spawned agents and normal client traffic to pass through a local provider endpoint | Good for proxy mode with provider base URL routing (see [Proxy](/docs/proxy)) |
