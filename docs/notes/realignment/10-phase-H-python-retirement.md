...
- `rust-dev.md` — promote the Rust proxy from "Phase 1 transparent reverse proxy" to "the proxy."
...
- `wiki/` — refresh.
- `docs/` — refresh.
- `rust-dev.md` — final form (renamed to `DEV.md` since there's no longer a Python/Rust split).
