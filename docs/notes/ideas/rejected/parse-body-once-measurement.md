...
- **Status:** rejected 2026-09-14 — gate failed on 3 days of log (n=1823):
  parse-minus-memory p50 13.74 ms, rewrite 3.08 ms, post 7.81 ms, all under
  the ≥20 ms gate. Step-2 rewrite slices retired.
