# Implemented: Drift/Expected recache split

- **Status:** implemented 2026-07-09 (`RecacheEventKind`, `event_kind` on `/cache-health`, two-window statusline, Prometheus relabel)
