...
def proxy(
    ...
    if not _use_python_proxy():
        ...
        return
    # Only the Python path needs these; the Rust binary returns above. The
    # malloc re-exec in particular would replace a process that is about to
    # exec the Rust proxy anyway.
